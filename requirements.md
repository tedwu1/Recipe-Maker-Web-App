...
6. **Name:** Delete Recipe
    ...
    - **Alternate Sequences:** 
        - User does not confirm deletion. 
            1. User is then redirected to the recipe page. 
    - **Post-conditions:** 
...
8. **Name:** Search Recipe 
    ...
    - **Alternate Sequences:** 
        * The system does not find a matching recipe name in the database 
            1. The system displays a “No Recipes Found” Error. 
    - **Post-conditions:** 
...
9. **Name:** Rate Recipe 
    ...
    - **Primary Sequence:**
        1. The user selects a range of star buttons corresponding to a rating from 1-5.
            - 5 is a high rating, 1 is a low rating. 
    ...
    - **Alternate Sequence:** 
        1. The user does not select a star. 
            - The user may press the X button at the corner to exit the “Rate Recipe” page. 
    - **Post-conditions:** 
...
10. **Name:** Comment on Recipe
    ...
    - **Alternate Sequence:** 
        1. The user types nothing into the text box. 
            - The “Post Comment” button will not appear clickable. 
    - **Post-conditions:** 
...
12. **Name:** Edit User Profile 
    ...
    - **Alternate Sequence:** 
        - 3. The user makes no edits to the form.
            - The “Submit” button will not appear clickable. 
    - **Post-conditions:** 
...
13. **Name:** Save Recipe (Favorites) 
    ...
    - **Alternate Sequence:** 
        1. The recipe is already in the "Favorites" list.
            - The system will display an error message “Recipe is already saved in Favorites"
    - **Post-conditions:** 
